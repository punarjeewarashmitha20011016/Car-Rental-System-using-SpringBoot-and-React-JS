...
class CustomerService{
    ...
    deleteCustomer = async(nic)=>{
        const promise = new Promise((resolve, reject) => {
            instance.delete(`customer?nic=${nic}`)   //10s
                .then((res) => {
                    return resolve(res)
                })
                .catch((er) => {
     ...
     fetchCustomers = async(data)=>{
        const promise = new Promise((resolve, reject) => {
            instance.get('customer/getAll')   //10s
                .then((res) => {
                    return resolve(res)
                })
                .catch((er) => {
    ...
    searchCustomer = async(userName,password)=>{
        const promise = new Promise((resolve, reject) => {
            instance.get(`customer/loginCheckCustomer?email=${userName}&password=${password}`)   //10s
                .then((res) => {
                    return resolve(res)
                })
                .catch((er) => {
